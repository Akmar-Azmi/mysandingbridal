...
<div x-data="{ openBooking: false, ...bookingForm() }">
        ...
        <section class="relative">
            ...
            <div class="absolute inset-0 bg-[#000000]/40 flex justify-center items-center text-white text-center"
                data-aos="fade-up">
        ...
        <section class="py-16 px-6 md:px-12 bg-white">
            <div class="max-w-7xl mx-auto grid md:grid-cols-2 gap-10 items-center">
                <div class="flex flex-col justify-center space-y-4 text-left" data-aos="fade-right">
                    ...
                    <p class="text-gray-600 mb-6">We bring beauty, tradition, and emotion together to create an
                        unforgettable celebration. Our packages are carefully curated to suit every taste and style.</p>
                    <a href="{{ route('about') }}"
                        class="w-fit inline-block border border-[#b98421] text-[#b98421] px-5 py-2 rounded-full text-sm hover:bg-[#b98421] hover:text-white transition duration-300">
                        About Us
                    </a>
                </div>
                ...
                @foreach ($services as $service)
                    <a href="{{ route('services') }}" class="text-center block">
                        <img src="{{ asset('images/' . $service['image']) }}"
                            class="rounded shadow mb-2 w-full h-48 object-cover" alt="{{ $service['name'] }}">
                        <div
                            class="text-xl font-jacques text-[#5d3c33] font-semibold hover:text-[#b98421] transition duration-300">
                            {{ $service['name'] }}
                        </div>
                    </a>
                @endforeach
        ...
        <section class="bg-white py-12 text-center grid grid-cols-1 md:grid-cols-3 gap-6 px-6" data-aos="zoom-in-up">
            <div x-data="{
                ...
                <div class="text-4xl font-bold text-[#5d3c33] font-mono">
                    <span x-text="count"></span>
                </div>
                <div class="text-lg font-jacques font-normal">Weddings</div>
            </div>
            ...
            <div x-data="{
                ...
                <div class="text-lg font-jacques font-normal">Happy Clients</div>
            </div>
           ...
           <div x-data="{
                ...
                <div class="text-lg font-jacques font-normal">Events Done</div>
            </div>
        </section>
        ...
        <section class="bg-white py-16 px-6" data-aos="fade-right">
            <div class="container mx-auto grid md:grid-cols-2 gap-8 items-center">
                <div>
                    ...
                    <p class="text-gray-600 mb-4">"Thank you to the Mysanding team. Everything was perfect — the pelamin,
                        outfits, food, DJ, and everything else. I pray for the Mysanding team’s success in all areas."</p>
                ...
                <img src="images/happybride2.jpg" alt="Client Image 1" class="rounded-xl shadow-lg w-full object-cover">
            </div>
        </section>
...
@section('scripts')
    ...
    <script>
    function rollUp(duration, number) {
        return {
            digits: [],
            init() {
                const numStr = number.toString();
                this.digits = numStr.split('').map((n, idx) => ({
                    id: idx,
                    html: `<span>${n}</span>`
                }));
            }
